        ...
        http
            ...
            .authorizeHttpRequests { auth ->
                auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/v1/products/**", "/api/v1/courts/**").permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/coaching/inquiry").permitAll()
                    .requestMatchers("/error", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs", "/v3/api-docs/**", "/webjars/**", "/actuator/health").permitAll()
